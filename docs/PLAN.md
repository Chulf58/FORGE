...
- [ ] 5. Update implement, debug, refactor skills to cross-check reviewer verdict file mtime (`skills/implement/SKILL.md`, `skills/debug/SKILL.md`, `skills/refactor/SKILL.md`) (wave: 3)
  Depends: 3
...
- [ ] 7. Tests green — all verify-output tests pass (`scripts/verify-output.test.mjs`) (wave: 4)
  Depends: 3, 4, 5, 6
