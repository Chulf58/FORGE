...
const THRESHOLDS = {
  ...
  'docs/gotchas/GENERAL.md': { max: 200, action: 'Split topic sections into docs/gotchas/<topic>.md (retrieval-backed) or trim stale entries via /forge:refresh — NOT FORGE-REFERENCE.md (that doc is generated by /forge:refresh-docs)' },
};
