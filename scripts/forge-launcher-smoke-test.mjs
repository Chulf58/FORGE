...
async function main() {
  ...
  // 4. Windows shim exists, starts with `@echo off`, and references forge.js.
  // Accepts both the bare-`node` form (Node on PATH) and the absolute-Node-path
  // form generated by hooks/mcp-deps-install.js on SessionStart for portable
  // Node installs.
